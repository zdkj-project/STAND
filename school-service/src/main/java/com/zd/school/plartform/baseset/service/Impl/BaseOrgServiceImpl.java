...
public class BaseOrgServiceImpl extends BaseServiceImpl<BaseOrg> implements BaseOrgService {
	...
	public Boolean delOrg(String delIds, SysUser currentUser) {
		// 删除班级
		boolean flag = gradeService.logicDelOrRestore(delIds, StatuVeriable.ISDELETE,currentUser.getXm());
		// 删除年级
		flag = classService.logicDelOrRestore(delIds, StatuVeriable.ISDELETE,currentUser.getXm());
		// 删除部门
		flag = this.logicDelOrRestore(delIds, StatuVeriable.ISDELETE,currentUser.getXm());
