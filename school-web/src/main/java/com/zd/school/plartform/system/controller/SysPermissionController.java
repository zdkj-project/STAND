...
public class SysPermissionController extends FrameWorkController<SysPermission> implements Constant {
   ...
   public void list(@ModelAttribute SysDatapermission entity, HttpServletRequest request, HttpServletResponse response)
       ...
       QueryResult<SysPermission> qr = thisService.doPaginationQuery(super.start(request), super.limit(request),
   ...
   */
   ...
   public void doUpdates(SysPermission entity, HttpServletRequest request, HttpServletResponse response)
           throws IOException, IllegalAccessException, InvocationTargetException {
