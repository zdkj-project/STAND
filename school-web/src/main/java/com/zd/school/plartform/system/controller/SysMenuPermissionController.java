 ...
 */
@Controller
@RequestMapping("/BaseMenuPermission")
public class SysMenuPermissionController extends FrameWorkController<SysMenuPermission> implements Constant {
	...
	public void list(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		QueryResult<SysMenuPermission> qr = thisService.doPaginationQuery(super.start(request), super.limit(request),
	...
	public void doUpdates(SysMenuPermission entity, HttpServletRequest request, HttpServletResponse response)
			throws IOException, IllegalAccessException, InvocationTargetException {
		// 获取当前操作用户
		String userCh = "超级管理员";
		SysUser currentUser = getCurrentSysUser();
