    ...
    control:{    
        ...
        "baseformwin[funCode=selectpms_detail] button[ref=formSave]": {
            beforeclick: function(btn) {
                var self=this;
                var win = btn.up("window");
                var selectMenuLayout = win.down("basepanel[xtype=roleright.selectpmslayout]");
                var selectedPermissionGrid = selectMenuLayout.down("panel[xtype=roleright.selectedpermissiongrid]");                        
                var funData = win.funData;
