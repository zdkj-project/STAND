...
Ext.define("core.system.roleright.view.selectedPermissionGrid", {
    ...
    alias: "widget.roleright.selectedpermissiongrid",
    al:false,
    frame: false,
    columnLines: false,
    dataUrl: comm.get("baseUrl") + "/BaseMenuPermission/getRoleMenuPerlist", //数据获取地址
    ...
    viewConfig: {
        ...
        listeners: {
            ...
            beforeitemdblclick: function(grid, record, item, index, e, eOpts) {
                ...
                var isSelectGrid = basePanel.down("panel[xtype=roleright.permissiongrid]");
